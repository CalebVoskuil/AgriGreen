...
VALUES ('20250426205027_InitialCreate', '8.0.0');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250426205438_AddFarmersEmployeesProducts', '8.0.0');
...
CREATE TABLE "Farmers" (
    "Id" INTEGER NOT NULL CONSTRAINT "PK_Farmers" PRIMARY KEY AUTOINCREMENT,
    "Name" TEXT NOT NULL,
    "UserId" TEXT NOT NULL,
    CONSTRAINT "FK_Farmers_AspNetUsers_UserId" FOREIGN KEY ("UserId") REFERENCES "AspNetUsers" ("Id") ON DELETE CASCADE
);
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250426210011_AddFarmersEmployeesProductsAgain', '8.0.0');
