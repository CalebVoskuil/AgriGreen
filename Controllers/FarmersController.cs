...
namespace AgriGreen.Controllers
{
    ...
    public class FarmersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,UserId")] Farmer farmer)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Users, "Id", "Id", farmer.UserId);
            return View(farmer);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,UserId")] Farmer farmer)
        {
            if (id != farmer.Id)
            {
                return NotFound();
